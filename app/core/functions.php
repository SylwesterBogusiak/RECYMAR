...
/** saves or displays a saved message to user **/
...
/** displays input values after page refresh **/
...
/** convert images from text editor content (textarea) to actual files**/
...
/** delete images from text editor content (textarea) **/
